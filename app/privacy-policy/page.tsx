        ...
        <div>
            ...
            <ul>
                ...
                <li>
                    ...
                    <p className="px-2">ユーザーが私たちに意見があったり、問題を報告したりする場合、ユーザーが送信した情報が一時的に保存されます。<br />
                       ユーザーが送信した内容(意見、問題内容等の情報)は3ヶ月間アーカイブされた後、永久に削除されます。</p>
                </li>
                <li>
                ...
                <li>
                    ...
                    <p className="px-2">私たちはユーザーの情報をいかなる場合においても、第三者に提供しません。<br />
                       例外として、サポートや問題報告の場合に限り、ユーザーが送信した情報をPrivShare運営グループ内に限り共有される可能性があります。</p>
                </li>
            </ul>
        </div>
        <div>
